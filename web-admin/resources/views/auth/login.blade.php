  ...
  <div class="auth-shell">
    ...
    <div class="auth-hero">
      ...
      <div class="hero-logo-wrap">
        {{-- ✅ Logo SVG inline (no depende de imagen externa) --}}
        <div class="hero-logo-img" style="display:flex;align-items:center;justify-content:center;background:linear-gradient(135deg,#1a6fcf,#12a98a);">
          <svg width="34" height="34" fill="none" viewBox="0 0 24 24" stroke="white" stroke-width="1.5">
    ...
    <div class="auth-form-side">
      ...
      @if($errors->any())
        <div class="alert-acx">
          ...
          {{ $errors->first('login') ?? $errors->first('auth') ?? 'Credenciales inv&aacute;lidas. Intenta de nuevo.' }}
        </div>
      @endif
