...
class LoansController extends Controller
{
    ...
    public function store(Request $request, MyBankApi $api)
    {
        ...
        $data = $request->validate([
            ...
            'interest_rate'           => ['required', 'numeric', 'min:3.50', 'max:7.50'],
            'payment_amount_override' => ['nullable', 'numeric', 'min:0'],
            'payments_count'          => ['required', 'integer', 'min:1', 'max:104'],
            ...
            'interest_rate.min'         => 'La tasa mínima es 3.50%.',
            'interest_rate.max'         => 'La tasa máxima es 7.50%.',
